...
# Fetch data
# -----------------------------------------------------------------------------
echo "Fetching necessary Terraform outputs for IaC repository"

REPO_NAME=$(terraform output --raw "iac_gh_repo_name")
REPO_ENV_NAME=$(terraform output --raw "iac_gh_env_name")
AWS_ROLE_ARN=$(terraform output --raw "iam_assumable_role_github_oidc_cicd_arn")
